...
public class Utils {
    ...
    public static void requestUserBluetooth(Activity activity) {
        ...
        activity.startActivityForResult(enableBtIntent, ClientActivity.REQUEST_ENABLE_BT);
    }
    ...
    public static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(ConnectDeviceActivity.BluetoothLeService.ACTION_GATT_CONNECTED);
        intentFilter.addAction(ConnectDeviceActivity.BluetoothLeService.ACTION_GATT_DISCONNECTED);
        intentFilter.addAction(ConnectDeviceActivity.BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED);
        intentFilter.addAction(ConnectDeviceActivity.BluetoothLeService.ACTION_DATA_AVAILABLE);
